...
function Navigation() {
  ...
  return (
    ...
    <nav className="hidden md:block font-genos bg-gradient-to-r from-[#7Ab2D3] to-[#7Ab2D3] shadow-lg sticky top-0 z-50 backdrop-blur-lg bg-opacity-90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* LOGO */}
          <Link
            to="/"
            className="flex items-center gap-2 flex-shrink-0 flex items-center group"
          >
            
            <span className="relative text-xl font-bold text-white group-hover:scale-105 transition-transform duration-300">
              <img
                src={logo}
                alt="Logo"
                className="h-10 rounded-full w-auto drop-shadow-lg"
              />
