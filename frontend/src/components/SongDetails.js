      ...
      <div className="p-6">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-800 truncate w-full">{currentSong.title}</h3>
        ...
        <div className="audio-controls">
          <div className="flex justify-center items-center mb-4">
            <button
              ...
              className={`p-2 rounded-full ${currentIndex <= 0 ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-gray-100'}`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-full ${currentIndex >= currentPlaylist.length - 1 ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 hover:bg-gray-100'}`}
            >
