      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center space-x-4">
          <button 
            ...
            className={`p-2 rounded-full ${currentIndex <= 0 ? 'text-gray-500 cursor-not-allowed' : 'text-white hover:bg-gray-800'}`}
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 13 20">
          ...
          <button 
            ...
            className={`p-2 rounded-full ${currentIndex >= currentPlaylist.length - 1 ? 'text-gray-500 cursor-not-allowed' : 'text-white hover:bg-gray-800'}`}
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 13 20">
