    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Thêm vào playlist</h3>
          <button 
            onClick={onClose} 
        ...
        <div className="modal-body">
          {playlists.length > 0 ? (
            <ul className="space-y-2 max-h-60 overflow-y-auto">
              {playlists.map((pl) => (
                <li key={pl.id} className="flex justify-between items-center p-2 rounded-lg hover:bg-gray-100">
            ...
            <p className="text-gray-500 text-center py-4">Bạn chưa có playlist nào.</p>
          )}
          {error && (
